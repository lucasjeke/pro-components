...
export const changelogPackageMenus: ChangelogPackageMenu[] = [
  ...
  {
    key: '/changelog/pro-descriptions',
    label: '/changelog/pro-descriptions',
    localeKey: 'proDescriptions',
  },
  {
  ...
  {
    key: '/changelog/pro-skeleton',
    label: '/changelog/pro-skeleton',
    localeKey: 'proSkeleton',
  },
  {
