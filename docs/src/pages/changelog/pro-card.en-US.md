...
> This page syncs `packages/card/CHANGELOG.md` and is generated by `pnpm docs:changelog` during release.

## V3.0.2

**Release date:** 2026-09-09

This release includes 1 highlight across `@antdv-next1/pro-card`.
...
- **@antdv-next1/pro-card**: Updated dependencies [ef5cfb6]
...
- **@antdv-next1/pro-card**: Updated dependencies [244f208]
...
This release includes 2 highlights across `@antdv-next1/pro-card`.
