...
ProComponents Vue is a template component based on Antdv Next that provides a higher level of abstraction support out of the box. It can significantly improve the efficiency of creating CRUD pages and focus more on them.
...
ProComponents Vue is focused on middle and backend CRUD and has a lot of pre-defined styles and behaviors. These behaviors and styles can be difficult to change, so if your business requires rich customization it is recommended to use Antdv Next directly.

## Installation

Currently each component of ProComponents Vue is a separate package, you need to install the corresponding npm package in your project and use it.
...
All of our packages use CSS-in-JS to manage styles, and you only need to import the js file.