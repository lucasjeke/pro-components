...
- feat!: remove the UMD bundle target from aggregate package builds.
- feat: publish ProDescriptions and ProSkeleton from the aggregate package.
- docs: sync structured changelog pages for every package.
...
- Restore MultiTab implementation while keeping layout sider width fixes.
- Updated dependencies
...
- Fix CheckCard group option style passthrough and fixed left sider placeholder width.
- Updated dependencies
...
- Fix ModalForm and DrawerForm layout prop forwarding.
- Updated dependencies
...
- fix MultiTab action bugs and add MultiTab Icon style
- Updated dependencies
...
- fix layout filed form card bugs
- Updated dependencies
...
- Fix layout multi-tab prop forwarding, make SettingDrawer extra settings extensible, and align docs deployment build command.
- Updated dependencies
...
- Fix layout MultiTab prop forwarding and compatibility handling.
- Updated dependencies
...
- Refine layout multi-tab rendering and setting drawer dark theme behavior.
- Updated dependencies
...
- prepare pro components publish
- Updated dependencies
