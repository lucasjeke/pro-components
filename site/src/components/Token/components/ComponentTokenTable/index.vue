...
import { LinkOutlined, QuestionCircleOutlined, RightOutlined } from '@antdv-next/icons'
import { theme } from 'antdv-next'
import { computed } from 'vue'
import tokenMetaRes from '@/assets/token-meta.json'
import tokenDataRes from '@/assets/token.json'
import ColorChunk from '@/components/ColorChunk/index.vue'
...
const componentTokens = computed(() => {
  ...
  console.log(components, components[props.component], 'components')
