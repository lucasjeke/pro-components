...
Schema Form uses `columns` to describe form structure and generates ProForm fields by `valueType`. It is useful for backend-driven forms, configurable forms, and reusing one field definition across Form, ModalForm, DrawerForm, QueryFilter, StepsForm, and other layouts.
